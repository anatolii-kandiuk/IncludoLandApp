...
urlpatterns = [
    ...
    path('games/my-story/', game_my_story, name='game_my_story'),
    path('games/activities/<int:activity_id>/', game_specialist_activity, name='game_specialist_activity'),
